      ...
      return (
        <main className="relative py-12 lg:py-20 w-full min-h-[80vh]">
          ...
          <div className="mx-auto w-full min-w-0 max-w-4xl flex flex-col items-center text-center px-4">
            <div className="inline-flex items-center rounded-full border border-brand-accent/20 bg-brand-accent/10 px-4 py-1.5 text-sm font-medium text-brand-accent mb-8 shadow-sm">
              <Book className="w-4 h-4 mr-2" />
              Bilgi Bankası
            </div>
            
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-brand-ink dark:text-white mb-6">
    ...
    <main className="relative py-6 lg:gap-10 lg:py-8 xl:grid xl:grid-cols-[1fr_250px] w-full">
      <div className="mx-auto w-full min-w-0">
        <div className="mb-8 space-y-4">
          <h1 className="scroll-m-20 text-3xl md:text-4xl font-bold tracking-tight text-brand-ink dark:text-white">
            {doc.title}
          </h1>
          {doc.description && (
