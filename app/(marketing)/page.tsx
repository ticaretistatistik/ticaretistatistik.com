    ...
    <div className="flex flex-col bg-background text-foreground overflow-hidden">
      ...
      */}
      <section className="relative min-h-[90vh] flex flex-col justify-center px-6 md:px-12 pt-32 pb-16">
        ...
        {/* Subtle glowing orb */}
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-brand-yellow/20 dark:bg-brand-yellow/10 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/3 pointer-events-none"></div>
      ...
      <section className="py-32 px-6 md:px-12 w-full max-w-[1600px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8">
          ...
          <div className="lg:col-span-8 flex flex-col gap-8 lg:mt-32">
            ...
            {/* Feature 1 */}
            <Link href="/docs" className="group flex flex-col md:flex-row items-start md:items-center gap-8 p-8 border border-border rounded-3xl bg-zinc-50 dark:bg-white/5 hover:bg-zinc-100 dark:hover:bg-white/10 transition-colors backdrop-blur-sm relative overflow-hidden">
              <span className="text-7xl font-serif text-zinc-100 dark:text-zinc-800 group-hover:text-brand-yellow/20 transition-colors absolute -top-4 -right-4 font-bold">01</span>
              ...
              <div className="h-16 w-16 rounded-full border border-border flex items-center justify-center group-hover:bg-brand-yellow group-hover:text-brand-ink group-hover:border-brand-yellow transition-all z-10 shrink-0 text-zinc-500 dark:text-zinc-400">
                <ArrowUpRight className="h-6 w-6" />
              </div>
            </Link>

            {/* Feature 2 */}
            <Link href="/topluluk/etkinliklerimiz" className="group flex flex-col md:flex-row items-start md:items-center gap-8 p-8 border border-border rounded-3xl bg-zinc-50 dark:bg-white/5 hover:bg-zinc-100 dark:hover:bg-white/10 transition-colors backdrop-blur-sm relative overflow-hidden">
              <span className="text-7xl font-serif text-zinc-100 dark:text-zinc-800 group-hover:text-brand-yellow/20 transition-colors absolute -top-4 -right-4 font-bold">02</span>
              <div className="flex-1 z-10">
            ...
            {/* Feature 3 */}
            <a href="https://open.spotify.com" target="_blank" rel="noreferrer" className="group flex flex-col md:flex-row items-start md:items-center gap-8 p-8 border border-border rounded-3xl bg-zinc-50 dark:bg-white/5 hover:bg-zinc-100 dark:hover:bg-white/10 transition-colors backdrop-blur-sm relative overflow-hidden">
              <span className="text-7xl font-serif text-zinc-100 dark:text-zinc-800 group-hover:text-brand-yellow/20 transition-colors absolute -top-4 -right-4 font-bold">03</span>
              <div className="flex-1 z-10">
