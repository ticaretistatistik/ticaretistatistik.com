...
export function Footer() {
  return (
    <footer className="border-t border-zinc-800 bg-brand-ink/50 py-12 px-4">
      <div className="container mx-auto max-w-[1200px]">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="https://instagram.com/ticaretistatistik" className="text-zinc-400 hover:text-brand-yellow transition-colors">
                <Instagram className="h-5 w-5" />
              </a>
              <a href="https://www.linkedin.com/company/i%CC%87statistik-toplulu%C4%9Futic" className="text-zinc-400 hover:text-brand-yellow transition-colors">
                <Linkedin className="h-5 w-5" />
              </a>
              <a href="https://github.com/ticaretistatistik" className="text-zinc-400 hover:text-brand-yellow transition-colors">
          ...
          <div>
            <h4 className="font-semibold text-white mb-4">Topluluk</h4>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-zinc-400">
              ...
              <li className="mt-4 p-4 border border-zinc-800 rounded-lg bg-zinc-900/50">
                <span className="block text-white font-medium mb-1">Aramıza Katıl</span>
        ...
        <div className="border-t border-zinc-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-zinc-500">
