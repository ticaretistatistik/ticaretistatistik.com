      ...
      <div className="container flex h-16 max-w-[1400px] items-center mx-auto px-4 sm:px-8">
        <div className="mr-4 flex">
          <Link href="/" className="mr-8 flex items-center space-x-2">
            <span className="font-serif font-bold text-lg text-foreground hidden sm:inline-block">
        ...
        <div className="flex flex-1 items-center justify-between space-x-2 md:justify-end">
          <div className="w-full flex-1 md:w-auto md:flex-none">
            <button className="inline-flex items-center justify-between rounded-full font-medium transition-colors border border-zinc-200 dark:border-zinc-700 bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 h-9 px-4 py-2 w-full md:w-64 text-sm text-zinc-500 dark:text-zinc-400 relative">
          ...
          <nav className="flex items-center gap-1">
            <ThemeToggle />
            <a href="https://instagram.com/ticaretistatistik" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors hover:bg-zinc-200 dark:hover:bg-zinc-800 hover:text-brand-yellow h-9 w-9 text-zinc-600 dark:text-zinc-400">
              <Instagram className="h-4 w-4" />
              <span className="sr-only">Instagram</span>
            </a>
            <a href="https://github.com/ticaretistatistik" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors hover:bg-zinc-200 dark:hover:bg-zinc-800 hover:text-brand-yellow h-9 w-9 text-zinc-600 dark:text-zinc-400">
